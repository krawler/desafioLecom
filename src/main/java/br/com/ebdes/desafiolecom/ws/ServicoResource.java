...
public class ServicoResource {
	...
	public @ResponseBody List<Servico> servicos(){
	...
	public @ResponseBody List<OrdemServico> ordensPorCliente(@RequestParam(value="id") String id){
	...
	public @ResponseBody List<OrdemServico> ordensNaoFinalizadas(@RequestParam(value="id") String id){
		List<OrdemServico> retorno = new ArrayList<OrdemServico>();
